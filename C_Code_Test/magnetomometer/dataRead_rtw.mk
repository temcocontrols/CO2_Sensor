###########################################################################
## File : dataRead_rtw.mk
## 
## Makefile generated for MATLAB file/project 'dataRead'. 
## 
## Makefile Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/dataRead.lib
...
PRODUCT_NAME              = dataRead
MAKEFILE                  = dataRead_rtw.mk
COMPUTER                  = PCWIN
ARCH                      = win32
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2013a
START_DIR                 = C:/Users/ASADUL~1/DOCUME~1/GitHub/MAGNET~1/MYWORK~1/codegen/lib/dataRead
...
TOOLCHAIN_MAKEFILE = dataRead_rtw_tools.mk

-include dataRead_rtw_tools.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/dataRead.lib
...
DEFINES_STANDARD = -DMODEL=dataRead -DHAVESTDIO -DUSE_RTMODEL
...
SRCS = $(START_DIR)/dataRead_initialize.c $(START_DIR)/dataRead_terminate.c $(START_DIR)/dataRead.c $(START_DIR)/dataRead_emxutil.c $(START_DIR)/dataRead_emxAPI.c $(START_DIR)/rt_nonfinite.c $(START_DIR)/rtGetNaN.c $(START_DIR)/rtGetInf.c

###########################################################################
## OBJECTS
###########################################################################

OBJS = dataRead_initialize.obj dataRead_terminate.obj dataRead.obj dataRead_emxutil.obj dataRead_emxAPI.obj rt_nonfinite.obj rtGetNaN.obj rtGetInf.obj
