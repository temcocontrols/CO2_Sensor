/*
 * File: _coder_tempCompenCO2_info.c
 *
...
/* Include files */
#include "_coder_tempCompenCO2_info.h"
...
static void info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]C:/Users/RajuPC/Desktop/GitHub/CO2_Sensor/code/Raju/MATLAB/TempCompensation for CO2/tempCompenCO2.m"),
                "context", 0);
...
mxArray *emlrtMexFcnProperties()
{
  ...
  mxSetFieldByNumber(xEntryPoints, 0, 0, mxCreateString("tempCompenCO2"));
...
/*
 * File trailer for _coder_tempCompenCO2_info.c
 *
 * [EOF]
 */
